  ...
  return (
    <div className="min-h-screen bg-slate-50 flex" id="finance-os-applet-shell">
      ...
      <aside 
        ...
        className={`fixed top-0 bottom-0 left-0 z-40 w-64 sm:w-60 bg-white border-r border-slate-100 flex flex-col transition-transform duration-300 lg:translate-x-0 ${
