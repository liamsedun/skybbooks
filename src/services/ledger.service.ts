...
export type CreateJournalEntryInput = {
  ...
  description: string;
  reference?: string;
  source: 'manual' | 'invoice' | 'bill' | 'payment' | 'payroll' | 'bank_feed' | 'opening_balance' | 'opening_stock' | 'transfer' | 'vat_settlement' | 'tax_provision' | 'inventory_adjustment' | 'loan' | 'owner_capital' | 'owner_drawings' | 'revenue_recognition' | 'lease' | 'ecl_provision' | 'fixed_asset';
  sourceId?: string;
  projectId?: string;
  createdBy: string;
