...
export const CSV_TEMPLATES: Record<string, { headers: string[]; sample: string[]; filename: string }> = {
  customers: {
    ...
    headers: ['code', 'name', 'email', 'phone', 'address', 'city', 'state', 'country', 'taxPin', 'paymentTerms (days)', 'creditLimit (NGN)', 'openingBalance (NGN)', 'currency', 'notes'],
    sample: ['CS-0002', 'Acme Corp', 'contact@acme.com', '+2348012345678', '123 Main St', 'Lagos', 'Lagos', 'Nigeria', 'PST-001', '30', '500000', '0', 'NGN', 'Preferred customer'],
  },
  quotes: {
    filename: 'quotes-template.csv',
    headers: ['customerCode (or name)', 'date (YYYY-MM-DD)', 'expiryDate', 'currency', 'notes', 'terms', 'line_description', 'line_quantity', 'line_unitPrice (NGN)', 'line_discountPct', 'line_taxRate'],
    sample: ['CS-0002', '2026-06-24', '2026-07-24', 'NGN', 'Quote notes', 'Standard terms', 'Consulting service', '1', '50000', '0', '7.5'],
  },
  salesOrders: {
    filename: 'sales-orders-template.csv',
    headers: ['customerCode (or name)', 'date (YYYY-MM-DD)', 'expectedDelivery', 'currency', 'notes', 'line_description', 'line_quantity', 'line_unitPrice (NGN)', 'line_discountPct', 'line_taxRate'],
    sample: ['CS-0002', '2026-06-24', '2026-07-24', 'NGN', 'Order notes', 'Product A', '10', '2500', '0', '7.5'],
  },
  invoices: {
    filename: 'invoices-template.csv',
    headers: ['customerCode (or name)', 'date (YYYY-MM-DD)', 'dueDate', 'currency', 'notes', 'terms', 'line_description', 'line_quantity', 'line_unitPrice (NGN)', 'line_discountPct', 'line_taxRate'],
    sample: ['CS-0002', '2026-06-24', '2026-07-24', 'NGN', 'Invoice notes', 'Net 30', 'Web development', '1', '200000', '0', '7.5'],
  },
  paymentsReceived: {
  ...
  creditNotes: {
    ...
    headers: ['customerCode (or name)', 'invoiceNumber (optional)', 'date (YYYY-MM-DD)', 'subtotal (NGN)', 'tax (NGN)', 'notes'],
    sample: ['CS-0002', 'INV-0001', '2026-06-24', '50000', '3750', 'Credit for damaged goods'],
  },
  recurringInvoices: {
    filename: 'recurring-invoices-template.csv',
    headers: ['customerCode (or name)', 'frequency', 'startDate (YYYY-MM-DD)', 'endDate', 'template_paymentTerms (days)', 'template_currency', 'template_notes', 'template_terms', 'line_description', 'line_quantity', 'line_unitPrice (NGN)', 'line_discountPct', 'line_taxRate'],
    sample: ['CS-0002', 'monthly', '2026-06-24', '2027-06-24', '30', 'NGN', 'Monthly retainer', 'Net 30', 'Retainer fee', '1', '100000', '0', '7.5'],
  },
  // Purchases module
  vendors: {
