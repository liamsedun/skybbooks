...
export function printWindow(title: string, bodyHtml: string, subtitle?: string) {
  const html = `<!DOCTYPE html><html><head><title>${title}</title><style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    @media print{body{padding:20px;color-adjust:exact;-webkit-print-color-adjust:exact;print-color-adjust:exact}div[style*="page-break-inside"],table[style*="page-break-inside"]{page-break-inside:avoid!important;break-inside:avoid!important}
  </style></head><body>
  <div class="header">
