...
export const employees = pgTable('employees', {
  ...
  grossSalary: integer('gross_salary').default(0).notNull(),
...
export const payrollRuns = pgTable('payroll_runs', {
  ...
  totalPaye: integer('total_paye').default(0).notNull(),
  totalPension: integer('total_pension').default(0).notNull(),
  totalNhf: integer('total_nhf').default(0).notNull(),
...
export const payrollLines = pgTable('payroll_lines', {
  ...
  basic: integer('basic').default(0).notNull(),
  housing: integer('housing').default(0).notNull(),
  transport: integer('transport').default(0).notNull(),
  otherAllowances: integer('other_allowances').default(0).notNull(),
  paye: integer('paye').default(0).notNull(),
  pensionEmployee: integer('pension_employee').default(0).notNull(),
  pensionEmployer: integer('pension_employer').default(0).notNull(),
  nhf: integer('nhf').default(0).notNull(),
  otherDeductions: integer('other_deductions').default(0).notNull(),
  netPay: integer('net_pay').default(0).notNull(),
  taxRelief: integer('tax_relief').default(0).notNull(),
  annualGross: integer('annual_gross').default(0).notNull(),
  createdAt: timestamp('created_at').defaultNow().notNull()
});
...
export const fixedAssets = pgTable('fixed_assets', {
  ...
  accumulatedDepreciation: integer('accumulated_depreciation').default(0).notNull(),
  bookValue: integer('book_value').notNull(),
  depreciationMethod: depreciationMethodEnum('depreciation_method').notNull(),
  usefulLifeMonths: integer('useful_life_months').notNull(),
  residualValue: integer('residual_value').default(0).notNull(),
  accountId: uuid('account_id').references(() => accounts.id).notNull(),
