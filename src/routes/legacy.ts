...
const legacyIncomeStatementSchema = z.object({
  ...
  data: z.object({
    operatingRevenue: z.number().default(0),
    otherOperatingIncome: z.number().default(0),
    totalRevenue: z.number().default(0),
    costOfSales: z.number().default(0),
    grossProfit: z.number().default(0),
    staffCosts: z.number().default(0),
    administrative: z.number().default(0),
    sellingDistribution: z.number().default(0),
    otherOperating: z.number().default(0),
    financeIncome: z.number().default(0),
    financeCosts: z.number().default(0),
    taxExpense: z.number().default(0),
...
const legacyCashFlowSchema = z.object({
  ...
  data: z.object({
    ...
    operatingActivities: z.object({
      adjustments: z.array(z.object({ name: z.string(), amount: z.number() })),
      adjustmentsTotal: z.number().default(0),
      workingCapitalChanges: z.array(z.object({ name: z.string(), amount: z.number() })),
      workingCapitalTotal: z.number().default(0),
      cashGeneratedFromOperations: z.number().default(0),
      incomeTaxPaid: z.number().default(0),
      interestPaid: z.number().default(0),
    ...
    netChangeInCash: z.number().default(0),
    openingCash: z.number().default(0),
    closingCash: z.number().default(0),
  }),
});
