...
router.get('/plans', async (_req: AuthenticatedRequest, res: Response, next: NextFunction) => {
  try {
    const plans = await db.select({
      ...
      modules: subscriptionPlans.modules,
      ...
      apiRequests: subscriptionPlans.apiRequests,
      maxWarehouses: subscriptionPlans.maxWarehouses,
      maxProjects: subscriptionPlans.maxProjects,
      maxAiRequests: subscriptionPlans.maxAiRequests,
