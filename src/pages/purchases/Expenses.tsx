...
function AccountSearchSelect({
  accounts, value, onChange, placeholder = 'Search and select account...',
}: { accounts: Account[]; value: string; onChange: (id: string) => void; placeholder?: string; }) {
          ...
          <div className="p-2 border-b border-slate-100">
            <div className="relative">
              ...
              <input autoFocus type="text" value={query} onChange={e => setQuery(e.target.value)}
                placeholder="Search accounts..." className="w-full pl-8 pr-3 py-1.5 text-xs border border-slate-200 rounded-md focus:outline-none focus:ring-1 focus:ring-slate-900/20" />
            </div>
          </div>
