...
function buildPayslipHtml(line: any, run: any, employee: any, calc: any, org: any): string {
  ...
  <style>
    ...
    *{margin:0;padding:0;box-sizing:border-box}
    body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',system-ui,sans-serif;background:#fff;font-size:12px;color:#0f172a;-webkit-font-smoothing:antialiased;width:210mm;height:297mm}
    .page{width:210mm;height:297mm;background:#fff;position:relative}
    .watermark{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%) rotate(-35deg);font-size:130px;font-weight:900;color:rgba(180,40,50,0.12);letter-spacing:18px;white-space:nowrap;pointer-events:none;z-index:0}
    .header{background:#1e3a5f;padding:12px 28px;display:flex;align-items:center;justify-content:space-between;position:relative;z-index:1}
    .header-left{display:flex;align-items:center;gap:12px}
    .header-logo{width:36px;height:36px;border-radius:9px;display:flex;align-items:center;justify-content:center;font-size:16px;font-weight:800;color:#fff;overflow:hidden;flex-shrink:0}
    .header-logo img{width:100%;height:100%;object-fit:cover;border-radius:7px}
    .header-logo .fallback{width:100%;height:100%;background:rgba(255,255,255,0.1);display:flex;align-items:center;justify-content:center;border-radius:7px}
    .header h1{color:#fff;font-size:16px;font-weight:700}
    .header .sub{color:#a0b8d4;font-size:8px;margin-top:2px;line-height:1.4}
    .header-right .badge{display:inline-block;background:rgba(255,255,255,0.12);color:#e8f0fe;padding:4px 16px;border-radius:16px;font-size:13px;font-weight:800;letter-spacing:0.04em}
    .body{padding:10px 28px 6px;position:relative;z-index:1}
    .emp-row{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:8px;padding-bottom:6px;border-bottom:1px solid #eef1f5}
    .emp-row .name{font-size:16px;font-weight:700;color:#1e3a5f}
    .emp-row .emp-meta{font-size:9.5px;color:#6b7a90;margin-top:2px}
    .emp-row .emp-meta span{display:inline-block;margin-right:10px}
    .emp-row .period{text-align:right;font-size:9.5px;color:#6b7a90;line-height:1.6}
    .emp-row .period strong{color:#1e3a5f;font-size:10px;font-weight:600}
    .grid-2{display:flex;gap:16px;margin-bottom:6px}
    .grid-2 > div{flex:1;min-width:0}
    .section-header{font-size:8px;font-weight:800;text-transform:uppercase;letter-spacing:0.1em;color:#8b9ab0;margin-bottom:4px}
    .card{border:1px solid #e2e8f0;border-radius:6px;overflow:hidden}
    .card-row{display:flex;justify-content:space-between;align-items:center;padding:5px 12px;font-size:10px;border-bottom:1px solid #f1f5f9}
    ...
    .card-row.total{border-top:1.5px solid #1e3a5f;margin-top:0;background:#f1f5f9;padding:5px 12px}
    .card-row.total .lb{font-weight:700;color:#1e3a5f}
    .card-row.total .vl{color:#1e3a5f}
    .relief-list{padding:2px 10px 2px;font-size:10px}
    ...
    .net-panel{background:linear-gradient(135deg,#1e3a5f,#2d5a87);border-radius:8px;padding:10px 20px;display:flex;justify-content:space-between;align-items:center;margin-bottom:8px}
    .net-panel .nl{color:#b8cfe8;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:0.06em}
    .net-panel .ns{color:#8aadd0;font-size:8px;margin-top:2px}
    .net-panel .na{color:#fff;font-size:24px;font-weight:800}
    table.bands{width:100%;border-collapse:separate;border-spacing:0;font-size:10px;border-radius:6px;overflow:hidden}
    table.bands th{padding:6px 12px;text-align:left;color:#fff;font-weight:700;font-size:8px;text-transform:uppercase;letter-spacing:0.07em;background:#1e3a5f}
    table.bands td{padding:5px 12px;border-bottom:1px solid #eef2f6;color:#1e293b;font-variant-numeric:tabular-nums;background:#fff}
    ...
    .metric-card{border:1px solid #e2e8f0;border-radius:6px;padding:6px 6px;text-align:center;background:#fafbfc}
    .metric-card .ml{font-size:7.5px;color:#8b9ab0;text-transform:uppercase;letter-spacing:0.05em;font-weight:700;margin-bottom:3px}
    .metric-card .mv{font-size:13px;font-weight:700;color:#0f172a;font-variant-numeric:tabular-nums}
    .footer{text-align:center;padding:6px 28px;border-top:1px solid #e2e8f0;font-size:8.5px;color:#94a3b8;position:relative;z-index:1}
        ...
        <div>
          ...
          <div class="card">
            ...
            ${calc ? `<div class="relief-list">
              <div style="font-weight:700;color:#1e3a5f;font-size:10px;padding:5px 0;border-bottom:1px solid #e2e8f0;margin-bottom:4px">Less: Tax Reliefs (Monthly)</div>
