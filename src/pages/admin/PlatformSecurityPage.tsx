  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-sm text-ink-500 mt-1">Platform security settings and configuration</p>
      </div>
      ...
      <div className="bg-surface rounded-xl border">
        <div className="px-5 py-4 border-b">
          <h3 className="text-sm font-semibold text-ink-700">Security Best Practices</h3>
        </div>
