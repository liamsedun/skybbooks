  ...
  return (
    <div className="p-4 sm:p-6 max-w-7xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl font-bold text-slate-900">Intercompany Transactions</h1>
          <p className="text-sm text-slate-500 mt-1">Manage transactions between organisations within a group.</p>
        </div>
      </div>
