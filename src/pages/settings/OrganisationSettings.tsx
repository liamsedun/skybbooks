...
const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Group Management', path: '/settings/groups', icon: Users },
    ],
  },
  {
    ...
    items: [
      ...
      { label: 'Tax Configuration', path: '/settings/tax', icon: Scale },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Email Settings', path: '/settings/email-settings', icon: Mail },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Posting Rules', path: '/settings/posting-rules', icon: Shield },
