      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-slate-100 pb-5">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-semibold border border-sky-200/80 text-sky-600 bg-sky-50 rounded-xl hover:bg-sky-100 transition-all duration-200 cursor-pointer"
          >
            <Download size={14} />
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-semibold border border-violet-200/80 text-violet-600 bg-violet-50 rounded-xl hover:bg-violet-100 transition-all duration-200 cursor-pointer"
          >
            <Database size={14} />
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-xl bg-gradient-to-r from-indigo-600 to-indigo-700 text-white hover:from-indigo-700 hover:to-indigo-800 transition-all duration-200 cursor-pointer self-start sm:self-center font-sans shadow-sm"
          >
                ...
                <div className="p-5 space-y-4">
                  ...
                  <div>
                    ...
                    <div className="font-sans font-bold text-slate-900 text-lg lg:text-xl">
                      {formatNaira(account.tbBalance ?? account.currentBalance ?? 0)}
                    </div>
                  </div>
