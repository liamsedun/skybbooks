...
export function OpsOffboardingPage() {
  ...
  return (
    <HrPageShell title="Offboarding" description="Employee exit management, clearance checklists, exit interviews, and final settlements."
      ...
      <HrConfirmDialog open={ps.confirmOpen} onClose={ps.closeConfirmDelete} onConfirm={() => { toast('Read-only view', 'error'); ps.closeConfirmDelete(); }} title="Delete Record" message="Are you sure you want to delete this offboarding record?" confirmLabel="Delete" variant="danger" />
      ...
      <HrFormModal open={ps.importOpen} onClose={() => ps.setImportOpen(false)} title="Import Offboarding Records" onSubmit={(e) => { e.preventDefault(); toast('Records imported', 'success'); ps.setImportOpen(false); }} submitLabel="Import">
