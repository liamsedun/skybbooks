...
export function OpsEmployeeEngagementPage() {
  ...
  return (
    <HrPageShell title="Employee Engagement" description="Pulse surveys, recognition programs, engagement analytics, and feedback tools."
      ...
      <HrConfirmDialog open={ps.confirmOpen} onClose={ps.closeConfirmDelete} onConfirm={() => { toast('Read-only view', 'error'); ps.closeConfirmDelete(); }} title="Delete Activity" message="Are you sure you want to delete this activity?" confirmLabel="Delete" variant="danger" />
      ...
      <HrFormModal open={ps.importOpen} onClose={() => ps.setImportOpen(false)} title="Import Activities" onSubmit={(e) => { e.preventDefault(); toast('Activities imported', 'success'); ps.setImportOpen(false); }} submitLabel="Import">
