...
import {
  ...
  Calendar, Clock, Award, Heart, Plane, UserPlus, ClipboardList, Headphones, CheckCircle, DoorOpen, UserCheck, Timer, LayoutGrid, GitBranch
} from 'lucide-react';
...
export function AppLayout({ currentView, onViewChange, children }: AppLayoutProps) {
  ...
  const pathMap: Record<string, string> = useMemo(() => ({
    ...
    hr_performance: '/app/hr/performance/overview',
    hr_compensation: '/app/hr/compensation', hr_comp_benefits: '/app/hr/compensation/benefits',
    hr_comp_allowances: '/app/hr/compensation/allowances', hr_comp_bonuses: '/app/hr/compensation/bonuses',
    hr_comp_deductions: '/app/hr/compensation/deductions', hr_comp_salary: '/app/hr/compensation/salary-reviews',
    hr_comp_paygrades: '/app/hr/compensation/pay-grades', hr_comp_history: '/app/hr/compensation/history',
    hr_comp_reports: '/app/hr/compensation/reports',
    hr_travel: '/app/hr/travel', hr_travel_requests: '/app/hr/travel/requests',
    hr_travel_advances: '/app/hr/travel/advances', hr_travel_expenses: '/app/hr/travel/expenses',
    hr_travel_settlements: '/app/hr/travel/settlements', hr_travel_history: '/app/hr/travel/history',
    hr_travel_reports: '/app/hr/travel/reports',
    hr_documents: '/app/hr/documents', hr_doc_files: '/app/hr/documents/files',
    hr_doc_categories: '/app/hr/documents/categories', hr_doc_employee: '/app/hr/documents/employee',
    hr_doc_versions: '/app/hr/documents/versions', hr_doc_reports: '/app/hr/documents/reports',
    hr_approvals: '/app/hr/approvals', hr_approvals_queue: '/app/hr/approvals/my-queue',
    hr_approvals_configs: '/app/hr/approvals/configs', hr_approvals_delegations: '/app/hr/approvals/delegations',
    hr_approvals_history: '/app/hr/approvals/history',
    hr_workflow: '/app/hr/workflow', hr_workflow_templates: '/app/hr/workflow/templates',
    hr_workflow_automation: '/app/hr/workflow/automation-rules',
    hr_workflow_notifications: '/app/hr/workflow/notifications',
    hr_workflow_reminders: '/app/hr/workflow/reminder-configs',
  ...
  const navigation: NavGroup[] = useMemo(() => [
    ...
    { title: 'SKYHRM', icon: UserCheck, moduleName: 'hrm', items: [
      ...
      { name: 'Performance', id: 'hr_performance', icon: BarChart3, permission: 'hr:read' },
      { name: 'Compensation', id: 'hr_compensation', icon: DollarSign, permission: 'hr:read' },
      { name: 'Travel Management', id: 'hr_travel', icon: Plane, permission: 'hr:read' },
      { name: 'Documents', id: 'hr_documents', icon: FileText, permission: 'hr:read' },
      { name: 'Approval Engine', id: 'hr_approvals', icon: CheckCircle, permission: 'hr:read' },
      { name: 'Workflow Engine', id: 'hr_workflow', icon: GitBranch, permission: 'hr:read' },
