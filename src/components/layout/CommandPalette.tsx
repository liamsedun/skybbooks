...
export function CommandPalette() {
  ...
  const commands: Command[] = useMemo(() => [
    ...
    { id: 'customers', label: 'Go to Customers', icon: Users, category: 'Navigation', action: () => navigate('/sales/customers') },
    { id: 'invoices', label: 'Go to Invoices', icon: FileText, category: 'Navigation', action: () => navigate('/sales/invoices') },
    { id: 'bills', label: 'Go to Bills', icon: FileText, category: 'Navigation', action: () => navigate('/purchases/bills') },
    { id: 'chart-of-accounts', label: 'Go to Chart of Accounts', icon: BookOpen, category: 'Navigation', action: () => navigate('/accountant/chart-of-accounts') },
    { id: 'journals', label: 'Go to Manual Journals', icon: FileCode, category: 'Navigation', action: () => navigate('/accountant/journals') },
    { id: 'reports', label: 'Go to Reports', icon: BarChart3, category: 'Navigation', action: () => navigate('/reports/trial-balance') },
    { id: 'vendors', label: 'Go to Vendors', icon: Building2, category: 'Navigation', action: () => navigate('/purchases/vendors') },
    { id: 'bank-accounts', label: 'Go to Bank Accounts', icon: CreditCard, category: 'Navigation', action: () => navigate('/banking') },
    { id: 'new-invoice', label: 'New Invoice', icon: PlusCircle, shortcut: 'Cmd+I', category: 'Actions', action: () => navigate('/sales/invoices/new') },
    { id: 'new-bill', label: 'New Bill', icon: PlusCircle, shortcut: 'Cmd+B', category: 'Actions', action: () => navigate('/purchases/bills/new') },
